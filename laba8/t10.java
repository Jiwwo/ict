...
public class test1 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++){
            if ((f1(arr[0][i],arr[1][i])&f1tri(arr[0][i],arr[1][i])&f1edge(arr[0][i],arr[1][i]))||
                    (f2(arr[0][i],arr[1][i])&f2tri(arr[0][i],arr[1][i])&f2edge(arr[0][i],arr[1][i]))) System.out.println("for x=" + arr[0][i]+ " y=" + arr[1][i] + " 0" + "\t");
            else if((f1(arr[0][i],arr[1][i])&f1tri(arr[0][i],arr[1][i]))||(f2(arr[0][i],arr[1][i])
                    &f2tri(arr[0][i],arr[1][i]))) System.out.println("for x=" + arr[0][i]+ " y=" + arr[1][i] + " 1"+ "\t" );
            else System.out.println("for x=" + arr[0][i]+ " y=" + arr[1][i] + " -1"+ "\t");
        }
    }
}
// fix edges 
